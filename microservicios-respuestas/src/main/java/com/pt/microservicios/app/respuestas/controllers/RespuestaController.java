package com.pt.microservicios.app.respuestas.controllers;
...
import com.pt.microservicios.app.respuestas.models.services.RespuestaService;
...
public class RespuestaController {
	...
	public ResponseEntity<?> obtenerExamenesIdsConRespuestasAlumnos(@PathVariable Long alumnoId){
		...
		Iterable<Long> examenesIds = service.findExamenesIdsConRespuestasBuAlumno(alumnoId);
